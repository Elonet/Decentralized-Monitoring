...
void Logstalgia::init() {
    ...
    if(summarizers.empty()) {
        ...
        addGroup("CODE", "Fail", "(?i)\\Fail\\b", 30,vec3(255,0,0));
        addGroup("CODE", "Danger", "(?i)\\Danger\\b", 30,vec3(255,50,0));
        addGroup("CODE", "Ok", "(?i)\\Ok\\b", 40,vec3(0,255,0));
    }
